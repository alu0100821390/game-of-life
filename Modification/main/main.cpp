...
/* Función que genera unos valores aleatorios para las variables especificadas */
void get_random (board_t &game, int &a, int &b){
	srand(time(NULL));
	a = rand() % (game.get_rows()-2) + 1;
	b = rand() % (game.get_columns()-2) + 1;
